...
class CrateItemEntity extends Entity
{
    ...
    public function entityBaseTick(int $tickDiff = 1): bool
    {
        ...
        if (!$this->isFlaggedForDespawn() && $this->isAlive()) {
            // calculate the distance we should have traveled
            $ageDist = self::Y_MOVE * $this->age;

            if ($ageDist >= $this->revealY && $ageDist < $this->destY) {
                if (!$this->revealed) {
...
//                    $this->setNameTagVisible();
                ...
                $this->move(0, self::Y_MOVE, 0);
                $this->reachedDest = false;
            } else if ($ageDist >= $this->destY) {
    ...
    {
        parent::sendData($targets, $data); // TODO: Change the autogenerated stub
    }
    ...
    protected function sendSpawnPacket(Player $player): void
    {
        ...
        if ($this->displayItem !== null) {
            ...
            $itemStack = EntityUtils::getFakeItemStack(EntityUtils::COMMAND_BLOCK_NETWORK_ID);
        }
